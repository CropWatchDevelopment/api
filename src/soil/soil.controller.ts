...
export class SoilController {
  ...
  @ApiOkResponse({ description: 'Soil data returned successfully.', type: SoilDataDto, isArray: true })
  ...
  @ApiInternalServerErrorResponse({
    ...
    type: ErrorResponseDto,
    example: { statusCode: 500, error: 'Internal Server Error', message: 'Failed to fetch soil data' },
  })
